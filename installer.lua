...
local to_get = {
  "extern:dog.lua:https://raw.githubusercontent.com/EvaisaDev/Dog/refresh/dog.lua",
  "extern:lib/turtle_aid.lua:https://raw.githubusercontent.com/EvaisaDev/Dog/refresh/lib/turtle_aid.lua",
